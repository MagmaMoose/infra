...
| --- | --- |
| **firefly** | The primary k3s cluster. Four nodes: a Raspberry Pi 5 control plane, one on-prem amd64 worker, and two arm64 OCI VMs. |
...
| **ff-oci1**, **ff-oci2** | The two arm64 OCI VMs, reachable over the VPN. |
