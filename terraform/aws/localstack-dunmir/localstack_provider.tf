...
provider "aws" {
  ...
  secret_key = "test" # checkov:skip=CKV_SECRET_6:LocalStack placeholder, not a real credential # nosemgrep: terraform.aws.security.aws-provider-static-credentials.aws-provider-static-credentials
